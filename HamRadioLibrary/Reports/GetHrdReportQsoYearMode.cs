...
namespace GetHrdReportQsoYearMode
{
    ...
    public class GetHrdReportQsoYearMode : Cmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            HamRadioDeluxe.ReportQsoYearMode();

            WriteVerbose("Reading list.");
            foreach (HRDProperties.ReportYearModeProperty QsoYearModeList in HamRadioDeluxe.HrdQsoYearModeList)
            {
